$(function () {
    ...
    if (tableElement.length > 0) {
        const table = tableElement.DataTable({
            ...
            columns: [
                ...
                { 
                    ...
                    orderable: false,
                    render: function(data) {
                        // Perbaikan Logika: Cek string 'Yes', bukan angka 1
                        if (data === 'Yes') {
                            // Warna Coklat Khas (#50200C)
        ...
        $(document).on('submit', '#form-edit-checkin', function(e) {
            ...
            $.ajax({
                url: url,
                type: 'POST', // Method spoofing PUT ada di dalam data serialized (@method('PUT'))
                data: data,
                success: function(response) {
                    // Tutup modal
                    // Cari modal instance yang sedang aktif dan hide
                    ...
                    // Tampilkan POP UP SUKSES (Menggunakan SweetAlert2 jika tersedia, fallback ke alert biasa)
                    ...
                    // Reload tabel untuk melihat harga & tanggal baru
